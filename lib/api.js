...
function portal_api_approvalchains(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_approvalchains.prototype.remove = function (p_approvalchain_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.remove' };
	if (p_approvalchain_id !== undefined)
		l_dict.approvalchain_id = p_approvalchain_id

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_approvalchains.prototype.list_all = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.list_all' };

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_approvalchains.prototype.update = function (p_approvalchain_id, p_active, p_steps, p_name, p_scope, p_template, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.update' };
	if (p_approvalchain_id !== undefined)
		l_dict.approvalchain_id = p_approvalchain_id
	if (p_active !== undefined)
		l_dict.active = p_active
	if (p_steps !== undefined)
		l_dict.steps = p_steps
	if (p_name !== undefined)
		l_dict.name = p_name
	if (p_scope !== undefined)
		l_dict.scope = p_scope
	if (p_template !== undefined)
		l_dict.template = p_template

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_approvalchains.prototype.add = function (p_active, p_steps, p_name, p_scope, p_template, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.add' };
	if (p_active !== undefined)
		l_dict.active = p_active
	if (p_steps !== undefined)
		l_dict.steps = p_steps
...
portal_api_approvalchains.prototype.apply_approvalchain_to_asset = function (p_approvalchain_id, p_url, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.apply_approvalchain_to_asset' };
	if (p_approvalchain_id !== undefined)
		l_dict.approvalchain_id = p_approvalchain_id
	if (p_url !== undefined)
		l_dict.url = p_url
...
portal_api_approvalchains.prototype.get_approvalchain_for_asset = function (p_url, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.get_approvalchain_for_asset' };
	if (p_url !== undefined)
		l_dict.url = p_url
...
portal_api_approvalchains.prototype.cancel_asset_approvalchain = function (p_url, p_callback, p_error_callback)
{
	var l_dict = { method: 'approvalchains.cancel_asset_approvalchain' };
	if (p_url !== undefined)
		l_dict.url = p_url
...
function portal_api_eventhandlers(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_eventhandlers.prototype.remove = function (p_eventhandler_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'eventhandlers.remove' };
	if (p_eventhandler_id !== undefined)
		l_dict.eventhandler_id = p_eventhandler_id

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_eventhandlers.prototype.list_all = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'eventhandlers.list_all' };

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_eventhandlers.prototype.update = function (p_eventhandler_id, p_name, p_script, p_scope, p_trigger, p_callback, p_error_callback)
{
	var l_dict = { method: 'eventhandlers.update' };
	if (p_eventhandler_id !== undefined)
		l_dict.eventhandler_id = p_eventhandler_id
	if (p_name !== undefined)
		l_dict.name = p_name
	if (p_script !== undefined)
		l_dict.script = p_script
	if (p_scope !== undefined)
		l_dict.scope = p_scope
	if (p_trigger !== undefined)
		l_dict.trigger = p_trigger

	return this.m_parent.server_call(this, l_dict, p_callback, p_error_callback);
}

portal_api_eventhandlers.prototype.add = function (p_name, p_script, p_scope, p_trigger, p_callback, p_error_callback)
{
	var l_dict = { method: 'eventhandlers.add' };
	if (p_name !== undefined)
		l_dict.name = p_name
	if (p_script !== undefined)
		l_dict.script = p_script
...
function portal_api_application(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_application.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.create' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_application.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_application.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.get' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_application.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
...
portal_api_application.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
...
portal_api_application.prototype.remove_keys = function (p_id, p_keys, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.remove_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_keys !== undefined)
		l_dict.keys = p_keys
...
portal_api_application.prototype.remove_keys_by_query = function (p_query, p_keys, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.remove_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_keys !== undefined)
		l_dict.keys = p_keys
...
portal_api_application.prototype.set_keys = function (p_id, p_key_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.set_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_application.prototype.set_keys_by_query = function (p_query, p_key_data, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.set_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data
...
portal_api_application.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'application.update' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
/***************************************************************************************************************************************
 * faceliftapplication API
 */

function portal_api_faceliftapplication(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_faceliftapplication.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.create' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_faceliftapplication.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_faceliftapplication.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.get' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_faceliftapplication.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields
...
portal_api_faceliftapplication.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
...
portal_api_faceliftapplication.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftapplication.update' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
function portal_api_faceliftpage(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_faceliftpage.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.create' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_faceliftpage.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_faceliftpage.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.get' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_faceliftpage.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields
...
portal_api_faceliftpage.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
...
portal_api_faceliftpage.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'faceliftpage.update' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_folder.prototype.get_changes = function (p_url, p_filter, p_client_time, p_timestamp, p_callback, p_error_callback)
{
	var l_dict = { method: 'folder.get_changes' };
	if (p_url !== undefined)
		l_dict.url = p_url
	if (p_filter !== undefined)
		l_dict.filter = p_filter
	if (p_client_time !== undefined)
		l_dict.client_time = p_client_time
...
function portal_api_media(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_media.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.create' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_media.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_media.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.get' };
	if (p_id !== undefined)
		l_dict.id = p_id
...
portal_api_media.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields
...
portal_api_media.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
...
portal_api_media.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'media.update' };
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_license.prototype.get_system_id = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'license.get_system_id' };
...
portal_api_whitepaper.prototype.backup = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'whitepaper.backup' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options
...
portal_api_whitepaper.prototype.restore = function (p_backup, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'whitepaper.restore' };
	if (p_backup !== undefined)
		l_dict.backup = p_backup
	if (p_options !== undefined)
		l_dict.options = p_options
...
portal_api_approval.prototype.assess_with_comment = function (p_approval_id, p_user_email, p_assessment, p_comment, p_callback, p_error_callback)
{
	var l_dict = { method: 'approval.assess_with_comment' };
	if (p_approval_id !== undefined)
		l_dict.approval_id = p_approval_id
	if (p_user_email !== undefined)
		l_dict.user_email = p_user_email
...
portal_api_approval.prototype.assess_with_comment_from_workable = function (p_workable_id, p_assessment, p_comment, p_callback, p_error_callback)
{
	var l_dict = { method: 'approval.assess_with_comment_from_workable' };
	if (p_workable_id !== undefined)
		l_dict.workable_id = p_workable_id
	if (p_assessment !== undefined)
		l_dict.assessment = p_assessment
...
function portal_api_pipeline(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_pipeline.prototype.call_mashup = function (p_host, p_port, p_ssl, p_mashup, p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'pipeline.call_mashup' };
	if (p_host !== undefined)
		l_dict.host = p_host
	if (p_port !== undefined)
		l_dict.port = p_port
	if (p_ssl !== undefined)
		l_dict.ssl = p_ssl
	if (p_mashup !== undefined)
		l_dict.mashup = p_mashup
	if (p_data !== undefined)
		l_dict.data = p_data
...
portal_api_site.prototype.finish_update_file = function (p_cloudflow_url, p_md5, p_md5_ad, p_data_type, p_apple_double, p_mod_time, p_signature, p_sender_site, p_callback, p_error_callback)
{
...
portal_api_site.prototype.list_files = function (p_sync_spec_name, p_mapping_id, p_time, p_signature, p_sender_site, p_callback, p_error_callback)
{
...
portal_api_site.prototype.remove_file_or_folder = function (p_url, p_signature, p_sender_site, p_callback, p_error_callback)
{
...
portal_api_syncspec.prototype.resync = function (p_spec, p_callback, p_error_callback)
{
	var l_dict = { method: 'syncspec.resync' };
	if (p_spec !== undefined)
		l_dict.spec = p_spec
...
function portal_api_base()
{
	...
	// modules
	this.application = new portal_api_application(this);
	...
	this.faceliftapplication = new portal_api_faceliftapplication(this);
	this.faceliftpage = new portal_api_faceliftpage(this);
	...
	this.media = new portal_api_media(this);
	...
	this.pipeline = new portal_api_pipeline(this);
