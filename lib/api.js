...
portal_api_asset.prototype.edit_comment = function (p_asset_id, p_note_id, p_comment_id, p_new_value, p_old_value, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'asset.edit_comment' };
	if (p_asset_id !== undefined)
		l_dict.asset_id = p_asset_id
	if (p_note_id !== undefined)
		l_dict.note_id = p_note_id
	if (p_comment_id !== undefined)
		l_dict.comment_id = p_comment_id
	if (p_new_value !== undefined)
		l_dict.new_value = p_new_value
	if (p_old_value !== undefined)
		l_dict.old_value = p_old_value
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "asset/edit_comment", l_dict, p_callback, p_error_callback);
}

portal_api_asset.prototype.edit_comment_by_url = function (p_asset_url, p_note_id, p_comment_id, p_new_value, p_old_value, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'asset.edit_comment_by_url' };
	if (p_asset_url !== undefined)
		l_dict.asset_url = p_asset_url
	if (p_note_id !== undefined)
		l_dict.note_id = p_note_id
	...
	return this.m_parent.server_call(this, "asset/edit_comment_by_url", l_dict, p_callback, p_error_callback);
}
...
portal_api_asset.prototype.import_xfdf = function (p_asset_id, p_fdf_url, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'asset.import_xfdf' };
	if (p_asset_id !== undefined)
		l_dict.asset_id = p_asset_id
	if (p_fdf_url !== undefined)
		l_dict.fdf_url = p_fdf_url
	if (p_options !== undefined)
		l_dict.options = p_options
...
portal_api_asset.prototype.import_xfdf_by_url = function (p_asset_url, p_fdf_url, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'asset.import_xfdf_by_url' };
	if (p_asset_url !== undefined)
		l_dict.asset_url = p_asset_url
	if (p_fdf_url !== undefined)
		l_dict.fdf_url = p_fdf_url
	...
	return this.m_parent.server_call(this, "asset/import_xfdf_by_url", l_dict, p_callback, p_error_callback);
}
...
portal_api_auth.prototype.login_with_options = function (p_user_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'auth.login_with_options' };
	if (p_user_name !== undefined)
		l_dict.user_name = p_user_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "auth/login_with_options", l_dict, p_callback, p_error_callback);
}
...
function portal_api_config(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_config.prototype.add_file_store = function (p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_file_store' };
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/add_file_store", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.add_file_store_mapping = function (p_server_name, p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_file_store_mapping' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/add_file_store_mapping", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.add_logical = function (p_server_name, p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_logical' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	...
	return this.m_parent.server_call(this, "config/add_logical", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.add_missing_workers = function (p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_missing_workers' };
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/add_missing_workers", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.add_worker = function (p_server_name, p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_worker' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	...
	return this.m_parent.server_call(this, "config/add_worker", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.add_work_server = function (p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.add_work_server' };
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/add_work_server", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.delete_file_store = function (p_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.delete_file_store' };
	if (p_name !== undefined)
		l_dict.name = p_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/delete_file_store", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.delete_file_store_mapping = function (p_server_name, p_mapping_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.delete_file_store_mapping' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_mapping_name !== undefined)
		l_dict.mapping_name = p_mapping_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/delete_file_store_mapping", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.delete_logical = function (p_server_name, p_logical_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.delete_logical' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_logical_name !== undefined)
		l_dict.logical_name = p_logical_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/delete_logical", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.delete_worker = function (p_server_name, p_worker_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.delete_worker' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_worker_name !== undefined)
		l_dict.worker_name = p_worker_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/delete_worker", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.delete_work_server = function (p_server_name, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.delete_work_server' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/delete_work_server", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.get_patchplanner = function (p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.get_patchplanner' };
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/get_patchplanner", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.get_settings = function (p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.get_settings' };
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/get_settings", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.list_file_stores = function (p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.list_file_stores' };
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/list_file_stores", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.list_work_servers = function (p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.list_work_servers' };
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/list_work_servers", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.setup = function (p_definition, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.setup' };
	if (p_definition !== undefined)
		l_dict.definition = p_definition
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/setup", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_file_store = function (p_name, p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_file_store' };
	if (p_name !== undefined)
		l_dict.name = p_name
	...
	return this.m_parent.server_call(this, "config/update_file_store", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_file_store_mapping = function (p_server_name, p_mapping_name, p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_file_store_mapping' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_mapping_name !== undefined)
		l_dict.mapping_name = p_mapping_name
	...
	return this.m_parent.server_call(this, "config/update_file_store_mapping", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_logical = function (p_server_name, p_name, p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_logical' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_name !== undefined)
		l_dict.name = p_name
	...
	return this.m_parent.server_call(this, "config/update_logical", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_patchplanner = function (p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_patchplanner' };
	if (p_changes !== undefined)
		l_dict.changes = p_changes
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/update_patchplanner", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_settings = function (p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_settings' };
	if (p_changes !== undefined)
		l_dict.changes = p_changes
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "config/update_settings", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_worker = function (p_server_name, p_worker_name, p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_worker' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_worker_name !== undefined)
		l_dict.worker_name = p_worker_name
	...
	return this.m_parent.server_call(this, "config/update_worker", l_dict, p_callback, p_error_callback);
}

portal_api_config.prototype.update_work_server = function (p_server_name, p_changes, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'config.update_work_server' };
	if (p_server_name !== undefined)
		l_dict.server_name = p_server_name
	if (p_changes !== undefined)
		l_dict.changes = p_changes
	...
	return this.m_parent.server_call(this, "config/update_work_server", l_dict, p_callback, p_error_callback);
}
...
portal_api_logging_trace.prototype.level_for = function (p_context, p_callback, p_error_callback)
{
	var l_dict = { method: 'logging.trace.level_for' };
	if (p_context !== undefined)
		l_dict.context = p_context

	return this.m_parent.server_call(this, "logging/trace/level_for", l_dict, p_callback, p_error_callback);
}
...
function portal_api_sheet(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_sheet.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "sheet/create", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "sheet/delete", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "sheet/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "sheet/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "sheet/get", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "sheet/list", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "sheet/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.remove_keys = function (p_id, p_keys, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.remove_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_keys !== undefined)
		l_dict.keys = p_keys

	return this.m_parent.server_call(this, "sheet/remove_keys", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.remove_keys_by_query = function (p_query, p_keys, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.remove_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_keys !== undefined)
		l_dict.keys = p_keys
	...
	return this.m_parent.server_call(this, "sheet/remove_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.set_keys = function (p_id, p_key_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.set_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data

	return this.m_parent.server_call(this, "sheet/set_keys", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.set_keys_by_query = function (p_query, p_key_data, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.set_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data
	...
	return this.m_parent.server_call(this, "sheet/set_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_sheet.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'sheet.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "sheet/update", l_dict, p_callback, p_error_callback);
}
...
portal_api_portal.prototype.get_portal_info = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'portal.get_portal_info' };

	return this.m_parent.server_call(this, "portal/get_portal_info", l_dict, p_callback, p_error_callback);
}
...
portal_api_portal.prototype.get_url = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'portal.get_url' };

	return this.m_parent.server_call(this, "portal/get_url", l_dict, p_callback, p_error_callback);
}
...
function portal_api_scope(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_scope.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "scope/create", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "scope/delete", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "scope/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "scope/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "scope/get", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "scope/list", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "scope/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_scope.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'scope.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "scope/update", l_dict, p_callback, p_error_callback);
}
...
function portal_api_template(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_template.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "template/create", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "template/delete", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "template/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "template/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "template/get", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "template/list", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "template/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_template.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'template.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "template/update", l_dict, p_callback, p_error_callback);
}
...
portal_api_proofscope.prototype.get_graphic_barcode_by_view_id = function (p_view_id, p_a_x, p_a_y, p_b_x, p_b_y, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.get_graphic_barcode_by_view_id' };
	...
	return this.m_parent.server_call(this, "proofscope/get_graphic_barcode_by_view_id", l_dict, p_callback, p_error_callback);
}
...
portal_api_proofscope.prototype.get_graphic_sample_by_view_id = function (p_view_id, p_x, p_y, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.get_graphic_sample_by_view_id' };
	if (p_view_id !== undefined)
		l_dict.view_id = p_view_id
	if (p_x !== undefined)
		l_dict.x = p_x
	...
	return this.m_parent.server_call(this, "proofscope/get_graphic_sample_by_view_id", l_dict, p_callback, p_error_callback);
}
...
portal_api_proofscope.prototype.get_view = function (p_view_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.get_view' };
	if (p_view_id !== undefined)
		l_dict.view_id = p_view_id

	return this.m_parent.server_call(this, "proofscope/get_view", l_dict, p_callback, p_error_callback);
}
...
portal_api_proofscope.prototype.edit_comment = function (p_view, p_note_id, p_comment_id, p_new_value, p_old_value, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.edit_comment' };
	if (p_view !== undefined)
		l_dict.view = p_view
	if (p_note_id !== undefined)
		l_dict.note_id = p_note_id
	...
	return this.m_parent.server_call(this, "proofscope/edit_comment", l_dict, p_callback, p_error_callback);
}
...
portal_api_notes.prototype.edit_comment = function (p_notes_id, p_note_id, p_comment_id, p_new_value, p_old_value, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'notes.edit_comment' };
	if (p_notes_id !== undefined)
		l_dict.notes_id = p_notes_id
	if (p_note_id !== undefined)
		l_dict.note_id = p_note_id
	...
	return this.m_parent.server_call(this, "notes/edit_comment", l_dict, p_callback, p_error_callback);
}
...
portal_api_notes.prototype.import_xfdf = function (p_notes_id, p_fdf_url, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'notes.import_xfdf' };
	if (p_notes_id !== undefined)
		l_dict.notes_id = p_notes_id
	if (p_fdf_url !== undefined)
		l_dict.fdf_url = p_fdf_url
	...
	return this.m_parent.server_call(this, "notes/import_xfdf", l_dict, p_callback, p_error_callback);
}
...
function portal_api_proofscope_tile(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_proofscope_tile.prototype.count = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.count' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "proofscope/tile/count", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "proofscope/tile/create", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "proofscope/tile/delete", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "proofscope/tile/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "proofscope/tile/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "proofscope/tile/get", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "proofscope/tile/list", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "proofscope/tile/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.remove_keys = function (p_id, p_keys, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.remove_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_keys !== undefined)
		l_dict.keys = p_keys

	return this.m_parent.server_call(this, "proofscope/tile/remove_keys", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.remove_keys_by_query = function (p_query, p_keys, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.remove_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_keys !== undefined)
		l_dict.keys = p_keys
	...
	return this.m_parent.server_call(this, "proofscope/tile/remove_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.set_keys = function (p_id, p_key_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.set_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data

	return this.m_parent.server_call(this, "proofscope/tile/set_keys", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.set_keys_by_query = function (p_query, p_key_data, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.set_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data
	...
	return this.m_parent.server_call(this, "proofscope/tile/set_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "proofscope/tile/update", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_tile.prototype.purge_by_access_time = function (p_date, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.tile.purge_by_access_time' };
	if (p_date !== undefined)
		l_dict.date = p_date

	return this.m_parent.server_call(this, "proofscope/tile/purge_by_access_time", l_dict, p_callback, p_error_callback);
}
...
function portal_api_proofscope_view(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_proofscope_view.prototype.count = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.count' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "proofscope/view/count", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "proofscope/view/create", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "proofscope/view/delete", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "proofscope/view/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "proofscope/view/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "proofscope/view/get", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "proofscope/view/list", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "proofscope/view/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.remove_keys = function (p_id, p_keys, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.remove_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_keys !== undefined)
		l_dict.keys = p_keys

	return this.m_parent.server_call(this, "proofscope/view/remove_keys", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.remove_keys_by_query = function (p_query, p_keys, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.remove_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_keys !== undefined)
		l_dict.keys = p_keys
	...
	return this.m_parent.server_call(this, "proofscope/view/remove_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.set_keys = function (p_id, p_key_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.set_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data

	return this.m_parent.server_call(this, "proofscope/view/set_keys", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.set_keys_by_query = function (p_query, p_key_data, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.set_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data
	...
	return this.m_parent.server_call(this, "proofscope/view/set_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "proofscope/view/update", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.get_by_view_id = function (p_view_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.get_by_view_id' };
	if (p_view_id !== undefined)
		l_dict.view_id = p_view_id

	return this.m_parent.server_call(this, "proofscope/view/get_by_view_id", l_dict, p_callback, p_error_callback);
}

portal_api_proofscope_view.prototype.purge_by_access_time = function (p_date, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'proofscope.view.purge_by_access_time' };
	if (p_date !== undefined)
		l_dict.date = p_date
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "proofscope/view/purge_by_access_time", l_dict, p_callback, p_error_callback);
}
...
portal_api_task_list.prototype.get_by_task_list_id = function (p_task_list_id, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'task_list.get_by_task_list_id' };
	if (p_task_list_id !== undefined)
		l_dict.task_list_id = p_task_list_id
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "task_list/get_by_task_list_id", l_dict, p_callback, p_error_callback);
}
...
function portal_api_team(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_team.prototype.count = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.count' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "team/count", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.create = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.create' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "team/create", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.delete = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.delete' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "team/delete", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.delete_multiple = function (p_ids, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.delete_multiple' };
	if (p_ids !== undefined)
		l_dict.ids = p_ids

	return this.m_parent.server_call(this, "team/delete_multiple", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.delete_by_query = function (p_query, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.delete_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "team/delete_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.get = function (p_id, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.get' };
	if (p_id !== undefined)
		l_dict.id = p_id

	return this.m_parent.server_call(this, "team/get", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "team/list", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "team/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.remove_keys = function (p_id, p_keys, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.remove_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_keys !== undefined)
		l_dict.keys = p_keys

	return this.m_parent.server_call(this, "team/remove_keys", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.remove_keys_by_query = function (p_query, p_keys, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.remove_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_keys !== undefined)
		l_dict.keys = p_keys
	...
	return this.m_parent.server_call(this, "team/remove_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.set_keys = function (p_id, p_key_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.set_keys' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data

	return this.m_parent.server_call(this, "team/set_keys", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.set_keys_by_query = function (p_query, p_key_data, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.set_keys_by_query' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_key_data !== undefined)
		l_dict.key_data = p_key_data
	...
	return this.m_parent.server_call(this, "team/set_keys_by_query", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.update = function (p_data, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.update' };
	if (p_data !== undefined)
		l_dict.data = p_data

	return this.m_parent.server_call(this, "team/update", l_dict, p_callback, p_error_callback);
}

portal_api_team.prototype.upload = function (p_contents, p_callback, p_error_callback)
{
	var l_dict = { method: 'team.upload' };
	if (p_contents !== undefined)
		l_dict.contents = p_contents

	return this.m_parent.server_call(this, "team/upload", l_dict, p_callback, p_error_callback);
}
...
portal_api_whitepaper.prototype.insert_partial_copy = function (p_id, p_from_id, p_node_id, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'whitepaper.insert_partial_copy' };
	if (p_id !== undefined)
		l_dict.id = p_id
	if (p_from_id !== undefined)
		l_dict.from_id = p_from_id
	if (p_node_id !== undefined)
		l_dict.node_id = p_node_id
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "whitepaper/insert_partial_copy", l_dict, p_callback, p_error_callback);
}
...
function portal_api_layout(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_layout.prototype.detect_crop_patch = function (p_files, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'layout.detect_crop_patch' };
	if (p_files !== undefined)
		l_dict.files = p_files
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "layout/detect_crop_patch", l_dict, p_callback, p_error_callback);
}

portal_api_layout.prototype.detect_patches = function (p_files, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'layout.detect_patches' };
	if (p_files !== undefined)
		l_dict.files = p_files
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "layout/detect_patches", l_dict, p_callback, p_error_callback);
}

portal_api_layout.prototype.to_tiff = function (p_layout, p_tiff, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'layout.to_tiff' };
	if (p_layout !== undefined)
		l_dict.layout = p_layout
	if (p_tiff !== undefined)
		l_dict.tiff = p_tiff
	...
	return this.m_parent.server_call(this, "layout/to_tiff", l_dict, p_callback, p_error_callback);
}
...
portal_api_printplanner.prototype.detect_full_patch_cropped = function (p_layout, p_url, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'printplanner.detect_full_patch_cropped' };
	if (p_layout !== undefined)
		l_dict.layout = p_layout
	if (p_url !== undefined)
		l_dict.url = p_url
	...
	return this.m_parent.server_call(this, "printplanner/detect_full_patch_cropped", l_dict, p_callback, p_error_callback);
}
...
portal_api_printplanner.prototype.preview_layout_to_tiff = function (p_layout, p_tiff, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'printplanner.preview_layout_to_tiff' };
	if (p_layout !== undefined)
		l_dict.layout = p_layout
	if (p_tiff !== undefined)
		l_dict.tiff = p_tiff
	...
	return this.m_parent.server_call(this, "printplanner/preview_layout_to_tiff", l_dict, p_callback, p_error_callback);
}
...
portal_api_tiff.prototype.merge = function (p_in_tiff1, p_in_tiff2, p_out_tiff, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'tiff.merge' };
	if (p_in_tiff1 !== undefined)
		l_dict.in_tiff1 = p_in_tiff1
	if (p_in_tiff2 !== undefined)
		l_dict.in_tiff2 = p_in_tiff2
	if (p_out_tiff !== undefined)
		l_dict.out_tiff = p_out_tiff
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "tiff/merge", l_dict, p_callback, p_error_callback);
}

portal_api_tiff.prototype.autoCrop = function (p_in_tiff, p_out_tiff, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'tiff.autoCrop' };
	if (p_in_tiff !== undefined)
		l_dict.in_tiff = p_in_tiff
	if (p_out_tiff !== undefined)
		l_dict.out_tiff = p_out_tiff
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "tiff/autoCrop", l_dict, p_callback, p_error_callback);
}
...
function portal_api_cip3(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_cip3.prototype.create_from_bitmaps = function (p_bitmaps, p_cip3, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'cip3.create_from_bitmaps' };
	if (p_bitmaps !== undefined)
		l_dict.bitmaps = p_bitmaps
	if (p_cip3 !== undefined)
		l_dict.cip3 = p_cip3
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "cip3/create_from_bitmaps", l_dict, p_callback, p_error_callback);
}

portal_api_cip3.prototype.create_from_file = function (p_file, p_cip3, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'cip3.create_from_file' };
	if (p_file !== undefined)
		l_dict.file = p_file
	if (p_cip3 !== undefined)
		l_dict.cip3 = p_cip3
	...
	return this.m_parent.server_call(this, "cip3/create_from_file", l_dict, p_callback, p_error_callback);
}
...
portal_api_xliff.prototype.scan_document = function (p_dbo_url, p_xliff_url, p_source_language, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'xliff.scan_document' };
	if (p_dbo_url !== undefined)
		l_dict.dbo_url = p_dbo_url
	if (p_xliff_url !== undefined)
		l_dict.xliff_url = p_xliff_url
	if (p_source_language !== undefined)
		l_dict.source_language = p_source_language
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "xliff/scan_document", l_dict, p_callback, p_error_callback);
}
...
portal_api_xliff.prototype.update_document = function (p_dbo_url, p_xliff_url, p_source_language, p_target_language, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'xliff.update_document' };
	if (p_dbo_url !== undefined)
		l_dict.dbo_url = p_dbo_url
	if (p_xliff_url !== undefined)
		l_dict.xliff_url = p_xliff_url
	if (p_source_language !== undefined)
		l_dict.source_language = p_source_language
	if (p_target_language !== undefined)
		l_dict.target_language = p_target_language
	if (p_options !== undefined)
		l_dict.options = p_options

	return this.m_parent.server_call(this, "xliff/update_document", l_dict, p_callback, p_error_callback);
}
...
function portal_api_stats(p_parent)
{
	this.m_parent = p_parent;
}

/***************************************************************************************************************************************
 * stats.active_users API
 */

function portal_api_stats_active_users(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_stats_active_users.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.active_users.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "stats/active_users/list", l_dict, p_callback, p_error_callback);
}

portal_api_stats_active_users.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.active_users.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "stats/active_users/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_stats_active_users.prototype.refresh = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.active_users.refresh' };

	return this.m_parent.server_call(this, "stats/active_users/refresh", l_dict, p_callback, p_error_callback);
}
...
function portal_api_stats_database(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_stats_database.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.database.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "stats/database/list", l_dict, p_callback, p_error_callback);
}

portal_api_stats_database.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.database.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "stats/database/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_stats_database.prototype.refresh = function (p_old_stats, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.database.refresh' };
	if (p_old_stats !== undefined)
		l_dict.old_stats = p_old_stats

	return this.m_parent.server_call(this, "stats/database/refresh", l_dict, p_callback, p_error_callback);
}
...
function portal_api_stats_workers(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_stats_workers.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.workers.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "stats/workers/list", l_dict, p_callback, p_error_callback);
}

portal_api_stats_workers.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.workers.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "stats/workers/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_stats_workers.prototype.refresh = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.workers.refresh' };

	return this.m_parent.server_call(this, "stats/workers/refresh", l_dict, p_callback, p_error_callback);
}


/***************************************************************************************************************************************
 * stats.work_servers API
 */

function portal_api_stats_work_servers(p_parent)
{
	this.m_parent = p_parent;
}

portal_api_stats_work_servers.prototype.list = function (p_query, p_fields, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.work_servers.list' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_fields !== undefined)
		l_dict.fields = p_fields

	return this.m_parent.server_call(this, "stats/work_servers/list", l_dict, p_callback, p_error_callback);
}

portal_api_stats_work_servers.prototype.list_with_options = function (p_query, p_order_by, p_fields, p_options, p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.work_servers.list_with_options' };
	if (p_query !== undefined)
		l_dict.query = p_query
	if (p_order_by !== undefined)
		l_dict.order_by = p_order_by
	...
	return this.m_parent.server_call(this, "stats/work_servers/list_with_options", l_dict, p_callback, p_error_callback);
}

portal_api_stats_work_servers.prototype.refresh = function (p_callback, p_error_callback)
{
	var l_dict = { method: 'stats.work_servers.refresh' };

	return this.m_parent.server_call(this, "stats/work_servers/refresh", l_dict, p_callback, p_error_callback);
}
...
function portal_api_base() {
	...
	this.cip3 = new portal_api_cip3(this);
	this.config = new portal_api_config(this);
	...
	this.layout = new portal_api_layout(this);
	...
	this.proofscope.tile = new portal_api_proofscope_tile(this);
	this.proofscope.view = new portal_api_proofscope_view(this);
	...
	this.scope = new portal_api_scope(this);
	this.scopes = new portal_api_scopes(this);
	this.screenpro = new portal_api_screenpro(this);
	this.share = new portal_api_share(this);
	this.sheet = new portal_api_sheet(this);
	this.site = new portal_api_site(this);
	this.software_update = new portal_api_software_update(this);
	this.stats = new portal_api_stats(this);
	this.stats.active_users = new portal_api_stats_active_users(this);
	this.stats.database = new portal_api_stats_database(this);
	this.stats.work_servers = new portal_api_stats_work_servers(this);
	this.stats.workers = new portal_api_stats_workers(this);
	...
	this.team = new portal_api_team(this);
	this.template = new portal_api_template(this);
